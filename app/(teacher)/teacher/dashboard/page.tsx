                    ...
                    {schedule.length > 0 ? (
                        <div className="space-y-4">
                            {schedule.map((routine) => (
                                <Card
                                    key={routine.id}
                                    className="hover-lift glass border-l-4 border-l-primary"
                                >
                                    <CardContent className="p-4 flex items-center justify-between">
                                        <div>
                                            <h4 className="font-bold text-lg">
                                                ...
                                                -{' '}
                                                {routine.allocation.course.name}
                                            </h4>
                                            <div className="flex items-center gap-2 text-sm text-muted-foreground mt-1">
                                                <Badge variant="secondary">
                                                    {routine.allocation.batch} -{' '}
                                                    {routine.allocation.section}
                                                </Badge>
                                                {routine.roomNo && (
                                        ...
                                        <div className="text-right">
                                            ...
                                            <div className="mt-2">
                                                <Link
                                                    href={`/teacher/attendance?allocationId=${routine.allocationId}`}
                                                >
                                                    <Button size="sm">
                                                        Take Attendance
                                                    </Button>
                    ...
                    <Card>
                        <CardContent className="p-0">
                            {[
                                ...
                                >
                                    <div
                                        className={`h-10 w-10 rounded-full bg-muted flex items-center justify-center ${item.color}`}
                                    >
