...
import { LayoutDashboard, CalendarCheck, FileCheck, Users, BookOpen, LogOut, GraduationCap, BarChart3 } from "lucide-react"

const sidebarItems = [
    { icon: LayoutDashboard, label: "Dashboard", href: "/teacher/dashboard" },
    { icon: CalendarCheck, label: "Mark Attendance", href: "/teacher/attendance" },
    { icon: BookOpen, label: "My Classes", href: "/teacher/classes" },
    { icon: BarChart3, label: "Reports", href: "/teacher/reports" },
    { icon: FileCheck, label: "Leave Requests", href: "/teacher/leaves" },
    { icon: Users, label: "Profile", href: "/teacher/profile" },
]
        ...
        <aside className="w-64 border-r bg-card/60 backdrop-blur-xl h-screen flex flex-col fixed left-0 top-0 shadow-premium-lg z-50">
            <div className="p-6 border-b flex items-center gap-3">
                ...
                <div className="flex flex-col">
                    <span className="font-bold text-lg gradient-text-university">Teacher Portal</span>
            ...
            {/* Profile Section */}
            <Link href="/teacher/profile" className="p-4 m-4 bg-muted/40 rounded-xl border border-border/40 hover:bg-muted/60 transition-colors cursor-pointer group">
